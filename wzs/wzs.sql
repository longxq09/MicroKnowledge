...
INSERT INTO `micro_notice` VALUES (7, 2, 1, 'Changqing Cheng', '-22-23-', '1-2', '', 'upub-conjecture', 'While complex systems generally exhibit multi-scale and multi-physics behaviors, machine learning can make the tedious simulation realistic.', '2020-04-26 13:35:02', 1);
INSERT INTO `micro_notice` VALUES (8, 2, 4, 'Matt Mihelic, MD', '-2-3-', '3-4', '', 'upub-conjecture', 'How will issues such as credentialing, privacy, payment, liability, and regulation be addressed in remote culture telemedicine?', '2020-05-09 13:35:02', 1);
INSERT INTO `micro_notice` VALUES (9, 2, 2, 'Kenneth Frumkin', '-2-3-', '5-6', '', 'upub-conjecture', 'Can pairing a unique taste with COVID vaccine create a safe, cheap, conditioned stimulus to boost immunity? Could warfighters carry such conditioned immunity boosters downrange in the event of tactical exposure to biological agents?', '2020-05-09 13:35:02', 1);
INSERT INTO `micro_notice` VALUES (10, 1, 2, 'Kenneth Frumkin', '-0-11-13-26-', 'Cohen, V., et al. (2015). ""Development of an opioid reduction protocol in an emergency department."" Am J Health Syst Pharm 72(23): 2080-2086.', 'pain-pain management-non opioids-combat-injury-analgesia-multimodal-certa', 'upub-evidence', 'In a 2015 proof-of-concept study, emergency patients with pain were successfully treated with an opioid-sparing protocol based on principles of channel enzyme receptor–targeted analgesia (CERTA).', '2018-10-26 13:35:02', 0);
INSERT INTO `micro_notice` VALUES (11, 1, 3, 'Jan Vandenbrande', '-21-30-22-', 'Michopoulos, Farhat, Fish, ""Modeling and Simulation of Multiphysics Systems"", Trans. of the ASME, Vol 5.', 'modeling multi physics-multi scale-simulation', 'upub-evidence', 'Survey paper describing challenges in multi-physics systems.', '2019-8-17 19:25:02', 0);
