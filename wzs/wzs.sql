...
INSERT INTO `micro_notice` VALUES (7, 2, 1, 'Changqing Cheng', '-22-23-', '1-2', '', 'upub-evidence', 'While complex systems generally exhibit multi-scale and multi-physics behaviors, machine learning can make the tedious simulation realistic.', '2020-04-26 13:35:02', 1);
INSERT INTO `micro_notice` VALUES (8, 2, 4, 'Matt Mihelic, MD', '-2-3-', '3-4', '', 'upub-evidence', 'How will issues such as credentialing, privacy, payment, liability, and regulation be addressed in remote culture telemedicine?', '2020-05-09 13:35:02', 1);
